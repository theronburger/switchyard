...
install -m 0644 "$repository_root/packaging/SwitchyardMenuIcon.png" "$app_bundle/Contents/Resources/SwitchyardMenuIcon.png"
cp -R "$swift_binary_directory/Switchyard_SwitchyardApp.bundle" "$app_bundle/Contents/Resources/Switchyard_SwitchyardApp.bundle"
install -m 0644 "$repository_root/THIRD_PARTY_NOTICES.md" "$app_bundle/Contents/Resources/THIRD_PARTY_NOTICES.md"
